...
const CreateDetalleOrdenCompraPage = () => {
    ...
    console.log("🚀 ~ CreateDetalleOrdenCompraPage ~ userData:", userData)
    ...
    return (
        <BoxMain className='fondo-con-imagen'>
            <Box flexDirection={'column'} height={'auto'} width={'auto'}>
                <TitleLeft>Crear Orden de Compra</TitleLeft>
                <Form sx={{ display: 'grid', gridTemplateColumns: '300px 300px 300px', gridTemplateRows: '70px 70px' }}>
                    <TextField
...
export default CreateDetalleOrdenCompraPage;