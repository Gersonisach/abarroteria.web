...
import '../src/components/styles/BackgroudImagen.css'
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/" element={<PrivateRoute tipoUsuarioPermitido="comprador"/>}>
            <Route path="/" element={<LayoutPage />}>
              <Route index element={<HomePage data={dataProducto} />} />           
          ...
          <Route path="/" element={<PrivateRoute tipoUsuarioPermitido="bodeguero"/>}>
            <Route path="/" element={<LayoutPage />}>
            <Route index element={<HomePage data={dataProducto} />} />
          ...
          <Route path='/' element={<PrivateRoute tipoUsuarioPermitido="administrador"/>}>
            <Route path="/" element={<LayoutPage />}>
              <Route index element={<HomePage data={dataProducto} />} />
              <Route path="proveedor/crear" element={<PageCustomizable modo={'crear'} data={dataProveedor} page={'Proveedor'} fields={fieldsProveedor} />} />
              <Route path="proveedor/actualizar" element={<PageCustomizable modo={'actualizar'} data={dataProveedor} page={'Proveedor'} fields={fieldsProveedor} />} />
          ...
          <Route path="/acceso-no-autorizado" element={<BoxMain><BoxMain className='fondo-con-imagen-not-autorized' width={'60%'} height={'60%'}/></BoxMain>} />
